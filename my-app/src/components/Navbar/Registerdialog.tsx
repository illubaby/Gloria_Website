    ...
    return (
        <>
            <div className="flex items-center">
                <button className="text-Blueviolet text-lg font-medium ml-4 py-2 px-4 transition duration-150 ease-in-out rounded-full bg-semiblueviolet hover:text-white hover:bg-Blueviolet" onClick={openModal}>
                    Sign up
                </button>
            </div>
